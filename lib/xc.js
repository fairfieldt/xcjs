var XCAction, XCColor, XCCompat, XCEvent, XCKeyDownEvent, XCKeyUpEvent, XCMoveAction, XCMoveBy, XCMoveTo, XCNode, XCRotateAction, XCRotateBy, XCRotateTo, XCScaleAction, XCScaleBy, XCScaleTo, XCScene, XCSpriteNode, XCTapDownEvent, XCTapMovedEvent, XCTapUpEvent, XCTextNode, _xcNodeAnchorX, _xcNodeAnchorY, _xcNodeColor, _xcNodeLayer, _xcNodeOpacity, _xcNodeRotation, _xcNodeScaleX, _xcNodeScaleY, _xcNodeSetAnchorX, _xcNodeSetAnchorY, _xcNodeSetColor, _xcNodeSetLayer, _xcNodeSetOpacity, _xcNodeSetRotation, _xcNodeSetScaleX, _xcNodeSetScaleY, _xcNodeSetVisible, _xcNodeSetX, _xcNodeSetY, _xcNodeVisible, _xcNodeX, _xcNodeY, _xcTextNodeText, _xcTextSetText, xc;
...
xc.prototype.removeEventListener = function(eventName, listener) {
  ...
  if ((typeof (_ref = this[eventName]) !== "undefined" && _ref !== null) && (pos = this[eventName].indexOf(listener) !== -1)) {
    return (this[eventName] = this[eventName].slice(0, pos).concat(this[eventName].slice(pos + 1, this[eventName].length)));
  } else {
    throw {
