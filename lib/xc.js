...
XCSequenceAction.prototype.tick = function(dt) {
  var currentAction;
  return (currentAction = this.actions[0]);
};
...
XCDelayAction = function(_arg) {
  this.time = _arg;
  XCDelayAction.__super__.constructor.call(this, 'XCDelayAction');
  return this;
};
__extends(XCDelayAction, XCAction);
